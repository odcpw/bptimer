/**
 * PracticeConfig.js - Meditation practice configuration and metadata
 * 
 * Central configuration for all meditation practices, categories, and UI theming.
 * This module defines the practice hierarchy, descriptions, and color schemes
 * used throughout the application.
 * 
 * @module PracticeConfig
 */
 ...
 * Used in session planning and recording
 */
export const POSTURES = ['Sitting', 'Standing', 'Walking', 'Lying down'];
 ...
 */
export function getCategoryForPractice(practiceName) {
 ...
 */
export function getPracticeInfo(practiceName) {
